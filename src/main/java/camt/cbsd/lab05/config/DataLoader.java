...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Course course2 = Course.builder().courseId("953323").courseName("SW Construction").build();
        Course course3 = Course.builder().courseId("953499").courseName("SW Project").build();
